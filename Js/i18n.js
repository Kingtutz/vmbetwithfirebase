...
const translations = {
  sv: {
    ...
    'common.knockout': 'Slutspel',
    'common.knockoutTopList': 'Slutspel Topplista',
    'common.admin': 'Admin',
    ...
    'leaderboard.showPicks': 'Klicka för att visa tips',
    'leaderboard.loadingPicks': 'Laddar användarens tips...',
    'leaderboard.couldNotLoadPicks': 'Kunde inte ladda användarens tips.',
    'leaderboard.noPicksForPlayer':
      'Den här användaren har inte lagt några tips än.',
    'leaderboard.picksFor': 'Tips för {user}',
    'leaderboard.pickLabel': 'Val: {pick}',
    'leaderboard.yourPickLabel': 'Ditt val: {pick}',
    'leaderboard.samePick': 'Samma som du',
    'leaderboard.differentPick': 'Annat än du',
    ...
    'admin.pickVisibilityTitle': 'Synlighet för val i procent',
    'admin.pickVisibilitySubtitle':
      'Välj om procentval ska visas endast för admin eller för alla användare.',
    'admin.pickVisibilityAdminsOnly': 'Synligt endast för admin',
    'admin.pickVisibilityEveryone': 'Synligt för alla användare',
    'admin.pickVisibilitySaved': 'Synlighetsinställningen sparades.',
    'admin.couldNotSavePickVisibility':
      'Kunde inte spara synlighetsinställningen.',
  ...
  en: {
    ...
    'common.knockoutTopList': 'Knockout Top List',
    'common.admin': 'Admin',
    ...
    'leaderboard.showPicks': 'Click to view picks',
    'leaderboard.loadingPicks': 'Loading user picks...',
    'leaderboard.couldNotLoadPicks': 'Could not load user picks.',
    'leaderboard.noPicksForPlayer': "This user hasn't made any picks yet.",
    'leaderboard.picksFor': 'Picks for {user}',
    'leaderboard.pickLabel': 'Pick: {pick}',
    'leaderboard.yourPickLabel': 'Your pick: {pick}',
    'leaderboard.samePick': 'Same as you',
    'leaderboard.differentPick': 'Different from you',
    ...
    'admin.pickVisibilityTitle': 'Pick distribution visibility',
    'admin.pickVisibilitySubtitle':
      'Choose whether pick percentages are shown to admins only or all users.',
    'admin.pickVisibilityAdminsOnly': 'Visible to admins only',
    'admin.pickVisibilityEveryone': 'Visible to all users',
    'admin.pickVisibilitySaved': 'Visibility setting saved.',
    'admin.couldNotSavePickVisibility': 'Could not save visibility setting.',
